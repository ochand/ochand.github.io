...
[![Portfolio](https://img.shields.io/badge/Portfolio-Live%20Site-blue?style=for-the-badge&logo=github-pages)](https://ochand.github.io)
...
### **[Agentic-MRP](https://github.com/UPC-MEI/Agentic-MRP)** - *Master's Thesis Project*
Autonomous agent-based MRP system with predictive analytics for manufacturing optimization
- **Tech**: Python, SimPy, FastAPI, Streamlit, Docker
- **Focus**: Discrete event simulation, supply chain intelligence

### **[LLM-Chat-RAG](https://github.com/UPC-MEI/LLM-Chat-RAG)**
Advanced AI chat system with Retrieval Augmented Generation using vector databases
- **Tech**: Python, OpenAI API, ChromaDB, FastAPI, Tesseract OCR
- **Features**: Explainable AI responses, source citation

### **[Himalayan-DataVis](https://github.com/UPC-MEI/Himalayan-DataVis)**
Interactive data science platform for mountaineering expedition analysis (2020-2024)
- **Tech**: Python, Streamlit, Altair, Pandas, NumPy
- **Status**: Ready for Streamlit Cloud deployment

### **[MuseoVirtualAR](https://github.com/UPC-MEI/MuseoVirtualAR)**
Augmented Reality museum experience with cultural heritage artifacts
- **Tech**: Unity, C#, Vuforia SDK, Android
- **Features**: Multi-marker tracking, multilingual system
...
- **[CFDI Full-Stack](https://github.com/Grupo-Chadorama/CFDI-backend)** - Mexican government tax compliance system
- **[uniCenta oPOS Fork](https://github.com/Grupo-Chadorama/unicentaopos-3.91.3)** - Open source POS system maintenance
- **[WebESCPOSPrint](https://github.com/Grupo-Chadorama/WebESCPOSprint)** - Java bridge for web-to-printer communication
...
- Agentic AI Systems, RAG Implementation, LLM Integration
- Manufacturing Intelligence, Computer Vision
- Applied Machine Learning, PyTorch & Keras

### **💻 Core Development**
- **Languages**: Python, Java, PHP, JavaScript, C#
- **Frameworks**: FastAPI, Laravel, Angular, Unity
- **Databases**: MySQL, SQL Server
- **Cloud & DevOps**: Docker, AWS, Git

### **🎮 Specialized**
- **XR/AR**: Unity, Vuforia, Google Cardboard
- **Creative Tech**: Audio Engineering, Music Production

---

## 🎵 **Creative Technology Bridge**

Beyond AI research and VR development, I'm **[The Ocean](https://instagram.com/theoceandj)** - a DJ and electronic music producer bridging creative artistry with technical innovation. My **[Audio-Splitter](https://github.com/ICRONOK/Audio-Splitter)** project demonstrates how deep technical expertise enhances creative workflows.

---

## 🌍 **Community Leadership**

- **PMI Sinaloa Chapter Founder** (2011-2013)
- **Technology Community Coordinator** - COLTSIN (2014-2016)  
- **Urban Mobility Advisor** - IMPLAN (2015-2022)
- **Startup Weekend Co-Organizer** - Fostering entrepreneurial ecosystem
...
Seeking **AI Engineering and Systems Architecture** positions that leverage both academic research and enterprise experience. Particularly interested in:
